...
- [H1ghBre4k3r/reactivebayes-agent-skills](https://github.com/H1ghBre4k3r/reactivebayes-agent-skills) - Coding-agent skills for idiomatic RxInfer, ReactiveMP, and RxEnvironments workflows. (2 days ago)
...
- [gitbutlerapp/gitbutler](https://github.com/gitbutlerapp/gitbutler) ([release/0.21.1](https://github.com/gitbutlerapp/gitbutler/releases/tag/release/0.21.1), 1 day ago) - The GitButler version control client, backed by Git, powered by Tauri/Rust/Svelte
...
- [auth-logging-sentry-metrics-integration](https://github.com/H1ghBre4k3r/kiebex/pull/41) on [H1ghBre4k3r/kiebex](https://github.com/H1ghBre4k3r/kiebex) (3 months ago)
...
- [git-for-windows/git](https://github.com/git-for-windows/git) - A fork of Git containing Windows-specific patches. (2 weeks ago)
