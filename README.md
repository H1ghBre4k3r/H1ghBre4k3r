...
- [gitbutlerapp/gitbutler](https://github.com/gitbutlerapp/gitbutler) ([release/0.17.6](https://github.com/gitbutlerapp/gitbutler/releases/tag/release/0.17.6), 1 week ago) - The GitButler version control client, backed by Git, powered by Tauri/Rust/Svelte
...
- [H1ghBre4k3r/guardia](https://github.com/H1ghBre4k3r/guardia) ([v0.5.0](https://github.com/H1ghBre4k3r/guardia/releases/tag/v0.5.0), 4 weeks ago) - The server monitoring solution from outer space.
...
- [ci: Enable Docker builds for tagged releases](https://github.com/H1ghBre4k3r/guardia/pull/49) on [H1ghBre4k3r/guardia](https://github.com/H1ghBre4k3r/guardia) (4 weeks ago)

#### ⭐ Recent Stars

- [sst/opencode](https://github.com/sst/opencode) - The AI coding agent built for the terminal. (2 weeks ago)
