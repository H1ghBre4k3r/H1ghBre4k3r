...
- [tom-tan/brainfuck-mode](https://github.com/tom-tan/brainfuck-mode) - Brainfuck mode for Emacs (1 day ago)
...
- [grovesNL/glow](https://github.com/grovesNL/glow) - GL on Whatever: a set of bindings to run GL anywhere and avoid target-specific code (1 day ago)
- [atuinsh/atuin](https://github.com/atuinsh/atuin) - ✨ Magical shell history (1 day ago)
- [mattgodbolt/atuin](https://github.com/mattgodbolt/atuin) - ✨ Magical shell history (1 day ago)
- [rust-lang/ferris-says](https://github.com/rust-lang/ferris-says) - A Rust flavored implementation of `cowsay` (5 days ago)
